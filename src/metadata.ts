export const metadata = [
  ...
  { path: "developer", title: "Developer | nate-games" },
  { path: "docs/get-started", title: "Getting Started | nate-games" },
  { path: "docs/sdk-html5", title: "SDK - HTML5 | nate-games" },
  { path: "docs/sdk-unity", title: "SDK - Unity | nate-games" },
  { path: "docs/sdk-construct", title: "SDK - Construct 3 | nate-games" },
